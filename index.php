...
<section class="blog" id="blog">
  <div class="section__container blog__container">
    <h2 class="section__header">BÀI VIẾT MỚI NHẤT</h2>

    <div class="blog__grid">

      <a href="blog-detail.php?id=1" class="blog__card">
      ...
      <a href="blog-detail.php?id=2" class="blog__card">
      ...
      <a href="blog-detail.php?id=3" class="blog__card">
      ...
      <a href="blog-detail.php?id=4" class="blog__card">
    ...
    <div class="blog__btn">
      <a href="viewall.php" class="btn btn__primary">XEM TẤT CẢ</a>
    </div>
