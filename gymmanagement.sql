...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th12 20, 2025 lúc 05:15 PM
...
(1, 'admin', 'admin123', 'Nguyễn Quản Trị', 'admin@gym.com'),
(2, 'staff01', 'staff123', 'Lê Lễ Tân', 'staff@gym.com');
...
(3, 3, 1, '2023-12-01', '2023-12-31', 'Active'),
...
INSERT INTO `notifications` (`notification_id`, `title`, `content`, `created_at`, `created_by`) VALUES
(1, 'Thông báo nghỉ lễ', 'Phòng tập sẽ đóng cửa vào ngày 01/01/2024 để bảo trì.', '2025-12-20 08:20:45', 1),
(2, 'Khuyến mãi Giáng sinh', 'Giảm 20% cho tất cả các gói gia hạn trước ngày 24/12.', '2025-12-20 08:20:45', 1);
...
(5, 3, 500000.00, 'Momo', 'Renewal', '2023-12-01 08:15:00', 'Gia hạn tháng 12'),
