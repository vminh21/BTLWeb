...
if (isset($_POST['btn_save'])) {
    ...
    try {
        if ($member_id === "new_member") {
            ...
            $sql_mem = "INSERT INTO members (full_name, status, email) VALUES ('$name', 'Active', '$fake_email')";
            if (!$conn->query($sql_mem)) {
                throw new Exception("Lỗi thêm thành viên: " . $conn->error);
            }
