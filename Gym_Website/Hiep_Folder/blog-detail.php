...
Việc duy trì một chế độ ăn lành mạnh kết hợp cùng với việc tập luyện thể thao thường xuyên sẽ giúp đem lại những lợi ích tuyệt vời cho sức khỏe. Do đó, bạn nên chú ý thực hiện theo nhằm mang lại kết quả tuyệt vời nhất."
    ...
    'b2' => [
        ...
        "content" => "Bắt đầu với việc tập thể dục
...
Có nhiều video online và tài nguyên miễn phí giúp bạn thử nghiệm mà không tốn chi phí."
    ],
    'b3' => [
        "title" => "Kỹ thuật tập luyện hiệu quả cho người bận rộn",
        "content" => "SKĐS – Bí quyết tập luyện cho người bận rộn
...
Việc xen kẽ các bài tập giúp bạn duy trì thói quen lâu dài mà không bỏ cuộc giữa chừng."
    ],
    'b4' => [
        "title" => "Cẩm nang chạy bộ cho người mới bắt đầu",
        "content" => "Lợi ích tuyệt vời của chạy bộ
...
<div class="container">
    ...
    <div class="nav-test">
        ...
        <div class="nav-links">
            <a href="?id=b1">Dinh dưỡng</a>
            <a href="?id=b2">Mục tiêu Fitness</a>
            <a href="?id=b3">Người bận rộn</a>
            <a href="?id=b4">Chạy bộ</a>
            </div>
    </div>
</div>
